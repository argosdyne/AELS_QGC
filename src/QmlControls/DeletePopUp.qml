...
Rectangle {
    ...
    implicitWidth: Screen.width / 4.334
    implicitHeight: Screen.height / 3.913

    Text{
        id: mainText
        text: qsTr("Are you sure to delete\nthe selected mission(s)?")
        color:"white"
        anchors.centerIn: parent
        font.pixelSize: root.width / 17
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Row {
                ...
                Image {
                    id: img
                    source: "/res/InfoWhite.svg"
                    width: topRect.height / 1.7
                    height: topRect.height / 1.7
