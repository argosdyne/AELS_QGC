...
public:
    ...
    Q_PROPERTY(TeamModeConfiguration* teamModeLink READ teamModeLink NOTIFY teamModeLinkChanged)
    Q_PROPERTY(TeamModeRouter* teamModeRouter READ teamModeRouter CONSTANT)
    ...
    TeamModeRouter* teamModeRouter() { return _teamModeRouter; }
    TeamModeConfiguration* teamModeLink() { return qobject_cast<TeamModeConfiguration*>(_teamModeLinkconfig.get()); }
...
private slots:
	...
	void _teamModeChanged();
	void _p2pConnectionStateChanged(int state);
...
private:
    ...
    TeamModeRouter* _teamModeRouter{nullptr};
    mDNSManager* _mDNSManager{nullptr};
    LTEManager* _lteManager{nullptr};
    SharedLinkConfigurationPtr _teamModeLinkconfig;
