...
Item {
    ...
    Rectangle {
        ...
        QGCLabel {
            ...
            property real zoomMultiple: camera.zoomMultiple
        ...
        QGCLabel {
            ...
            Connections {
                ...
                onOperationResultChanged: {
                    if (result === 0) {
                        resultLabel.text = qsTr("Photo captured.")
                    } else if (result === 1) {
                        resultLabel.text = qsTr("Photo capture failed.")
                    } else if (result === 4) {
                        resultLabel.text = qsTr("Recording failed.")
                    } else if (result === -1) {
                        resultLabel.text = qsTr("No zoom in 4K video.")
                    }
